...
gemspec = eval(File.read("pdftk-form.gemspec"))

task :build => "#{gemspec.full_name}.gem"

file "#{gemspec.full_name}.gem" => gemspec.files + ["pdftk-form.gemspec"] do
  system "gem build pdftk-form.gemspec"
  system "gem install pdftk-form-#{PdfForms::VERSION}.gem"
end
